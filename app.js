...
async function data(City) {
  ...
  try {
    ...
    document.querySelector(".weather1").innerHTML = "☀️ " + result.forecast.forecastday[0].day.condition.text;
    ...
    document.querySelector(".weather2").innerHTML = "☀️ " + result.forecast.forecastday[1].day.condition.text;
    ...
    document.querySelector(".weather3").innerHTML = "☀️ " + result.forecast.forecastday[2].day.condition.text;
